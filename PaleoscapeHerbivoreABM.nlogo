...
globals[
  ...
  herbivores                ; agentset that includes all herbivores
  day-count                 ; The number of days a simulation has run
  hour-of-day               ; The hour of the day
  predation-risk1           ; The risk of predation for Small Non-Social Browsers
  predation-risk2           ; The risk of predation for Medium Sized Social Browsers
  predation-risk3           ; The risk of predation for Large Browsers
  predation-risk4           ; The risk of predation for water-dependent grazers
  predation-risk5           ; The risk of predation for non-ruminants

  veg-type1-encountered     ; Records the number of herbivores encountered by lions at vegetation type 1
  veg-type2-encountered     ; Records the number of herbivores encountered by lions at vegetation type 2
  veg-type3-encountered     ; Records the number of herbivores encountered by lions at vegetation type 3
  veg-type4-encountered     ; Records the number of herbivores encountered by lions at vegetation type 4
  veg-type5-encountered     ; Records the number of herbivores encountered by lions at vegetation type 5
  veg-type6-encountered     ; Records the number of herbivores encountered by lions at vegetation type 6
  veg-type7-encountered     ; Records the number of herbivores encountered by lions at vegetation type 7
  veg-type8-encountered     ; Records the number of herbivores encountered by lions at vegetation type 8
  veg-type9-encountered     ; Records the number of herbivores encountered by lions at vegetation type 9
  veg-type10-encountered    ; Records the number of herbivores encountered by lions at vegetation type 10
  veg-type11-encountered    ; Records the number of herbivores encountered by lions at vegetation type 11
  veg-type12-encountered    ; Records the number of herbivores encountered by lions at vegetation type 12
  veg-type13-encountered    ; Records the number of herbivores encountered by lions at vegetation type 13
  veg-type14-encountered    ; Records the number of herbivores encountered by lions at vegetation type 14

]

patches-own [
  vt                        ; vegetation/coastal resource type
  SNSBr-deaths-here         ; The number of Small Non-Social Browsers killed here
  MSMix-deaths-here         ; The number of Medium Sized Social Browsers s killed here
  LBr-deaths-here           ; The number of Large Browsers killed here
  WDGr-deaths-here          ; The number of water-dependent grazers  killed here
  NRum-deaths-here          ; The number of non-ruminants killed here
  total-kills-here          ; The total number of herbivores killed here
  vegetation-condition      ; 1-10 scale of the quality of forage in a location
]

turtles-own [
  hours-since-water         ; Number of hours since animal had water
  herbivore?                ; Records if an animal is a herbivore
  hours-without-water       ; Number of hours since an animal last had water
  target-water-patch        ; Nearby water patch an agent is moving towards
  heading-to-water?         ; True if an animal is moving towards water
  population-size           ; The number of animals represented by an agent
  predation-risk            ; The base predation risk for each herbivore type

  veg-type1-traversed       ; Number of times Vegetation Type 1 was crossed by an agent
  veg-type2-traversed       ; Number of times Vegetation Type 2 was crossed by an agent
  veg-type3-traversed       ; Number of times Vegetation Type 3 was crossed by an agent
  veg-type4-traversed       ; Number of times Vegetation Type 4 was crossed by an agent
  veg-type5-traversed       ; Number of times Vegetation Type 5 was crossed by an agent
  veg-type6-traversed       ; Number of times Vegetation Type 6 was crossed by an agent
  veg-type7-traversed       ; Number of times Vegetation Type 7 was crossed by an agent
  veg-type8-traversed       ; Number of times Vegetation Type 8 was crossed by an agent
  veg-type9-traversed       ; Number of times Vegetation Type 9 was crossed by an agent
  veg-type10-traversed      ; Number of times Vegetation Type 10 was crossed by an agent
